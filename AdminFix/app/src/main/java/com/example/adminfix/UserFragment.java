...
public class UserFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        bottomNavUser = getView().findViewById(R.id.bottomNavUser);
        changeUserFragment(new AddUserFragment(), "");
        bottomNavUser.setOnNavigationItemSelectedListener(
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        if (menuItem.getItemId() == R.id.menuaddpeople){
                            ...
                            changeUserFragment(new EditUserFragment(), "");
                        }
                        return true;
                    }
                }
    ...
    public void changeUserFragment(Fragment f, String data) {
        ...
        ft.replace(R.id.containeruser, f);
        ft.commit();
    }
