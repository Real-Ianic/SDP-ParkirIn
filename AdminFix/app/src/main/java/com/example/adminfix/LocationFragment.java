...
public class LocationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        changeLocationFragment(new AddLokasiFragment(), "");
        bottomNavLocation.setOnNavigationItemSelectedListener(
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    @Override
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        if (menuItem.getItemId() == R.id.menuaddlocation){
                            changeLocationFragment(new AddLokasiFragment(), "");
                        }
                        else if (menuItem.getItemId() == R.id.menueditlocation){
                            changeLocationFragment(new EditLokasiFragment(), "");
                        }
                        return true;
                    }
                }
