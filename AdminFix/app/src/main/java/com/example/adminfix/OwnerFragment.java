...
public class OwnerFragment extends Fragment {
    ...
    BottomNavigationView bottomNavOwner;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        bottomNavOwner = getView().findViewById(R.id.bottomNavOwner);
        changeOwnerFragment(new AddOwnerFragment(), "");
        bottomNavOwner.setOnNavigationItemSelectedListener(
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        if (menuItem.getItemId() == R.id.menuaddpeople){
                            ...
                            changeOwnerFragment(new EditOwnerFragment(), "");
                        }
                        return true;
                    }
                }
